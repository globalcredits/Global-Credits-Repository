...
unsigned int nStakeMaxAge = 60 * 60 * 24 * 100; // stake age of full weight
unsigned int nStakeTargetSpacing = 60; // 60 seconds block spacing
int64 nChainStartTime = 1406833601;
...
const string strMessageMagic = "Globalcredits Signed Message:\n";
...
// Globalcredits: increasing Nfactor gradually
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Globalcredits", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
  ...
  //vMerkleTree: 05b4eb8ba8 
        ...
        // Genesis block
        const char* pszTimestamp = "Globalcredits is launched.";
        CTransaction txNew;
...
assert(block.hashMerkleRoot == uint256("0xdf479f45ea5bc02ef55e3d3787f5de4390534d467445d07aa481b25a269ac133"));
        block.print();  
