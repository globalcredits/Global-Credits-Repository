#############################################################################
# Makefile for building: GlobalCredits.app/Contents/MacOS/GlobalCredits
# Generated by qmake (2.01a) (Qt 4.8.5) on: Sun Aug 3 19:52:03 2014
# Project:  Glob-qt.pro
# Template: app
# Command: /opt/local/bin/qmake USE_UPNP=- -o Makefile Glob-qt.pro
#############################################################################
...
CC            = /usr/bin/clang
CXX           = /usr/bin/clang++
DEFINES       = -DQT_GUI -DBOOST_THREAD_USE_LIB -DBOOST_SPIRIT_THREADSAFE -DSCRYPT_CHACHA -DSCRYPT_KECCAK512 -DBOOST_THREAD_PROVIDES_GENERIC_SHARED_MUTEX_ON_WIN -D__NO_SYSTEM_INCLUDES -DUSE_IPV6=1 -DHAVE_BUILD_INFO -DMAC_OSX -DMSG_NOSIGNAL=0 -DQT_NO_DEBUG -DQT_GUI_LIB -DQT_CORE_LIB -DQT_SHARED
CFLAGS        = -pipe -O3 -msse2 -O2 -arch x86_64 -Xarch_x86_64 -mmacosx-version-min=10.7 -pthread -no-integrated-as -Wall -W $(DEFINES)
CXXFLAGS      = -pipe -fstack-protector-all --param ssp-buffer-size=1 -msse2 -O2 -arch x86_64 -Xarch_x86_64 -mmacosx-version-min=10.7 -pthread -fdiagnostics-show-option -Wall -Wextra -Wformat -Wformat-security -Wno-unused-parameter -Wstack-protector $(DEFINES)
INCPATH       = -I/opt/local/share/qt4/mkspecs/macx-g++ -Ibuild -I/opt/local/Library/Frameworks/QtCore.framework/Versions/4/Headers -I/opt/local/Library/Frameworks/QtGui.framework/Versions/4/Headers -Isrc -Isrc/json -Isrc/qt -I/opt/local/include/db48 -I/opt/local/Library/Frameworks/QtGui.framework/Versions/4/Headers -I/opt/local/Library/Frameworks/QtCore.framework/Versions/4/Headers -I/opt/local/include -Ibuild
LINK          = /usr/bin/clang++
LFLAGS        = -headerpad_max_install_names -fstack-protector-all --param ssp-buffer-size=1 -arch x86_64 -all_load -pthread -Xarch_x86_64 -mmacosx-version-min=10.7
LIBS          = $(SUBLIBS)   -ldb_cxx -framework Foundation -framework ApplicationServices -framework AppKit -L/opt/local/lib -L/opt/local/lib/db48 -lssl -lcrypto -ldb_cxx-4.8 -lboost_system-mt -lboost_filesystem-mt -lboost_program_options-mt -lboost_thread-mt -framework QtGui -F/opt/local/Library/Frameworks -framework QtCore 
AR            = ar cq
RANLIB        = ranlib -s
...
DIST          = /opt/local/share/qt4/mkspecs/common/unix.conf \
		...
		Glob-qt.pro
QMAKE_TARGET  = GlobalCredits
DESTDIR       = 
TARGET        = GlobalCredits.app/Contents/MacOS/GlobalCredits
...
all: Makefile GlobalCredits.app/Contents/PkgInfo GlobalCredits.app/Contents/Resources/empty.lproj GlobalCredits.app/Contents/Info.plist GlobalCredits.app/Contents/Resources/bitcoin.icns $(TARGET)

$(TARGET): /Users/User/Desktop/GitHub-GC/build/build.h build/ui_sendcoinsdialog.h build/ui_addressbookpage.h build/ui_signverifymessagedialog.h build/ui_aboutdialog.h build/ui_editaddressdialog.h build/ui_transactiondescdialog.h build/ui_overviewpage.h build/ui_sendcoinsentry.h build/ui_askpassphrasedialog.h build/ui_rpcconsole.h build/ui_optionsdialog.h $(OBJECTS)  
	@$(CHK_DIR_EXISTS) GlobalCredits.app/Contents/MacOS/ || $(MKDIR) GlobalCredits.app/Contents/MacOS/ 
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: Glob-qt.pro  /opt/local/share/qt4/mkspecs/macx-g++/qmake.conf /opt/local/share/qt4/mkspecs/common/unix.conf \
		/opt/local/share/qt4/mkspecs/common/mac.conf \
		/opt/local/share/qt4/mkspecs/common/gcc-base.conf \
		/opt/local/share/qt4/mkspecs/common/gcc-base-macx.conf \
		/opt/local/share/qt4/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) USE_UPNP=- -o Makefile Glob-qt.pro
...
GlobalCredits.app/Contents/PkgInfo: 
	@$(CHK_DIR_EXISTS) GlobalCredits.app/Contents || $(MKDIR) GlobalCredits.app/Contents 
	@$(DEL_FILE) GlobalCredits.app/Contents/PkgInfo
	@echo "APPL????" >GlobalCredits.app/Contents/PkgInfo
GlobalCredits.app/Contents/Resources/empty.lproj: 
	@$(CHK_DIR_EXISTS) GlobalCredits.app/Contents/Resources || $(MKDIR) GlobalCredits.app/Contents/Resources 
	@touch GlobalCredits.app/Contents/Resources/empty.lproj
	
GlobalCredits.app/Contents/Info.plist: 
	@$(CHK_DIR_EXISTS) GlobalCredits.app/Contents || $(MKDIR) GlobalCredits.app/Contents 
	@$(DEL_FILE) GlobalCredits.app/Contents/Info.plist
	@sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,@TYPEINFO@,????,g" -e "s,@ICON@,bitcoin.icns,g" -e "s,@EXECUTABLE@,GlobalCredits,g" -e "s,@TYPEINFO@,????,g" /opt/local/share/qt4/mkspecs/macx-g++/Info.plist.app >GlobalCredits.app/Contents/Info.plist
GlobalCredits.app/Contents/Resources/bitcoin.icns: src/qt/res/icons/bitcoin.icns
	@$(CHK_DIR_EXISTS) GlobalCredits.app/Contents/Resources/ || $(MKDIR) GlobalCredits.app/Contents/Resources/ 
	@$(DEL_FILE) GlobalCredits.app/Contents/Resources/bitcoin.icns
	@$(COPY_FILE) src/qt/res/icons/bitcoin.icns GlobalCredits.app/Contents/Resources/bitcoin.icns
dist: 
	@$(CHK_DIR_EXISTS) build/GlobalCredits1.0.0.0 || $(MKDIR) build/GlobalCredits1.0.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/GlobalCredits1.0.0.0/ && $(COPY_FILE) --parents src/qt/locale/bitcoin_en.ts src/qt/locale/bitcoin_ru.ts build/GlobalCredits1.0.0.0/ && $(COPY_FILE) --parents src/qt/macdockiconhandler.mm build/GlobalCredits1.0.0.0/ && $(COPY_FILE) --parents src/qt/bitcoingui.h src/qt/transactiontablemodel.h src/qt/addresstablemodel.h src/qt/optionsdialog.h src/qt/sendcoinsdialog.h src/qt/addressbookpage.h src/qt/signverifymessagedialog.h src/qt/aboutdialog.h src/qt/editaddressdialog.h src/qt/bitcoinaddressvalidator.h src/alert.h src/addrman.h src/base58.h src/bignum.h src/checkpoints.h src/compat.h src/sync.h src/util.h src/uint256.h src/kernel.h src/scrypt_mine.h src/pbkdf2.h src/serialize.h src/strlcpy.h src/main.h src/net.h src/key.h src/db.h src/walletdb.h src/script.h src/init.h src/irc.h src/mruset.h src/json/json_spirit_writer_template.h src/json/json_spirit_writer.h src/json/json_spirit_value.h src/json/json_spirit_utils.h src/json/json_spirit_stream_reader.h src/json/json_spirit_reader_template.h src/json/json_spirit_reader.h src/json/json_spirit_error_position.h src/json/json_spirit.h src/qt/clientmodel.h src/qt/guiutil.h src/qt/transactionrecord.h src/qt/guiconstants.h src/qt/optionsmodel.h src/qt/monitoreddatamapper.h src/qt/transactiondesc.h src/qt/transactiondescdialog.h src/qt/bitcoinamountfield.h src/wallet.h src/keystore.h src/qt/transactionfilterproxy.h src/qt/transactionview.h src/qt/walletmodel.h src/bitcoinrpc.h src/qt/overviewpage.h src/qt/csvmodelwriter.h src/crypter.h src/qt/sendcoinsentry.h src/qt/qvalidatedlineedit.h src/qt/bitcoinunits.h src/qt/qvaluecombobox.h src/qt/askpassphrasedialog.h src/protocol.h src/qt/notificator.h src/qt/qtipcserver.h src/allocators.h src/ui_interface.h src/qt/rpcconsole.h src/version.h src/netbase.h src/clientversion.h src/qt/macdockiconhandler.h build/GlobalCredits1.0.0.0/ && $(COPY_FILE) --parents src/qt/bitcoin.qrc build/GlobalCredits1.0.0.0/ && $(COPY_FILE) --parents src/qt/bitcoin.cpp src/qt/bitcoingui.cpp src/qt/transactiontablemodel.cpp src/qt/addresstablemodel.cpp src/qt/optionsdialog.cpp src/qt/sendcoinsdialog.cpp src/qt/addressbookpage.cpp src/qt/signverifymessagedialog.cpp src/qt/aboutdialog.cpp src/qt/editaddressdialog.cpp src/qt/bitcoinaddressvalidator.cpp src/alert.cpp src/version.cpp src/sync.cpp src/util.cpp src/netbase.cpp src/key.cpp src/script.cpp src/main.cpp src/init.cpp src/net.cpp src/irc.cpp src/checkpoints.cpp src/addrman.cpp src/db.cpp src/walletdb.cpp src/qt/clientmodel.cpp src/qt/guiutil.cpp src/qt/transactionrecord.cpp src/qt/optionsmodel.cpp src/qt/monitoreddatamapper.cpp src/qt/transactiondesc.cpp src/qt/transactiondescdialog.cpp src/qt/bitcoinstrings.cpp src/qt/bitcoinamountfield.cpp src/wallet.cpp src/keystore.cpp src/qt/transactionfilterproxy.cpp src/qt/transactionview.cpp src/qt/walletmodel.cpp src/bitcoinrpc.cpp src/rpcdump.cpp src/rpcnet.cpp src/rpcmining.cpp src/rpcwallet.cpp src/rpcblockchain.cpp src/rpcrawtransaction.cpp src/qt/overviewpage.cpp src/qt/csvmodelwriter.cpp src/crypter.cpp src/qt/sendcoinsentry.cpp src/qt/qvalidatedlineedit.cpp src/qt/bitcoinunits.cpp src/qt/qvaluecombobox.cpp src/qt/askpassphrasedialog.cpp src/protocol.cpp src/qt/notificator.cpp src/qt/qtipcserver.cpp src/qt/rpcconsole.cpp src/noui.cpp src/kernel.cpp src/scrypt-x86.S src/scrypt-x86_64.S src/scrypt_mine.cpp src/pbkdf2.cpp src/scrypt-jane/scrypt-jane.c build/GlobalCredits1.0.0.0/ && $(COPY_FILE) --parents src/qt/macdockiconhandler.mm build/GlobalCredits1.0.0.0/ && $(COPY_FILE) --parents src/qt/forms/sendcoinsdialog.ui src/qt/forms/addressbookpage.ui src/qt/forms/signverifymessagedialog.ui src/qt/forms/aboutdialog.ui src/qt/forms/editaddressdialog.ui src/qt/forms/transactiondescdialog.ui src/qt/forms/overviewpage.ui src/qt/forms/sendcoinsentry.ui src/qt/forms/askpassphrasedialog.ui src/qt/forms/rpcconsole.ui src/qt/forms/optionsdialog.ui build/GlobalCredits1.0.0.0/ && $(COPY_FILE) --parents src/qt/locale/bitcoin_en.ts src/qt/locale/bitcoin_ru.ts build/GlobalCredits1.0.0.0/ && (cd `dirname build/GlobalCredits1.0.0.0` && $(TAR) GlobalCredits1.0.0.0.tar GlobalCredits1.0.0.0 && $(COMPRESS) GlobalCredits1.0.0.0.tar) && $(MOVE) `dirname build/GlobalCredits1.0.0.0`/GlobalCredits1.0.0.0.tar.gz . && $(DEL_FILE) -r build/GlobalCredits1.0.0.0
...
distclean: clean
	-$(DEL_FILE) -r GlobalCredits.app
	-$(DEL_FILE) Makefile


/Users/User/Desktop/GitHub-GC/build/build.h: FORCE
	cd /Users/User/Desktop/GitHub-GC; /bin/sh share/genbuild.sh /Users/User/Desktop/GitHub-GC/build/build.h
...
qrc_bitcoin.cpp: src/qt/bitcoin.qrc \
		...
		src/qt/res/icons/Globalcredits-16.png \
		src/qt/res/icons/Globalcredits-128.png \
